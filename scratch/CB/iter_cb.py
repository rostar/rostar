...
class CBEMClampedFiberStressResidualIter(RF):
    '''
...
class CBEMClampedFiberStressResidualSPIter(CBEMClampedFiberStressResidualIter):
        '''
        ...
        def __call__(self, w, x, tau, l, E_f, E_m, theta, Pf,
            ...
            if self.q != 0.0:
                ...
                q = super(CBEMClampedFiberStressResidualSPIter, self).__call__(w,
...
if __name__ == '__main__':
    ...
    def Pw():
        ...
        P = CBEMClampedFiberStressResidualIter()
    ...
    def SP():
        plt.figure()
        cbcsp = CBEMClampedFiberStressResidualSPIter()
        x = np.linspace(-60, 40, 300)
        w = .4
