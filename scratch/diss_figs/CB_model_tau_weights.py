...
from quaducom.meso.homogenized_crack_bridge.elastic_matrix.reinforcement import FiberBundle
from quaducom.meso.homogenized_crack_bridge.elastic_matrix.hom_CB_elastic_mtrx import CompositeCrackBridge
from matplotlib import pyplot as plt

class RandomBondCB(CompositeCrackBridge):
    
#===============================================================================
# Parameters
#===============================================================================    
    reinforcement_lst = List(Instance(FiberBundle))
...
#===============================================================================        
    ...
    def profile(self, iter_damage, Lmin, Lmax):
        ...
        damage portion and boundary condtion
        '''
...
#===============================================================================        
    ...
    def damage_residuum(self, iter_damage):
        if np.any(iter_damage < 0.0) or np.any(iter_damage > 1.0):
            ...
            eval_damage = self.vect_xi_cdf(epsf0, x_short=x_short, x_long=x_long)
            residuum = eval_damage - iter_damage
            return residuum
