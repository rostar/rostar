...
if __name__ == '__main__':
    ...
    macro = GFRCMarco(meso_model=meso,
                      W=40., H=40., L=200., Lf=18.,
                      r=13e-3, Vf=.00020, N_fil=10,
                      Ef=70e3, snub=0.5, xi=1e15, w_arr=w_arr)
    for i in np.arange(3):
        macro.Ef += 0.00001
        response = macro.CB_response_MC_simulation
        plt.plot(w_arr, response)
    plt.show()
